...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-background px-4 py-3 text-foreground sm:px-8 sm:py-5 lg:px-10">
      <div className="mx-auto flex min-h-[calc(100vh-1.5rem)] w-full max-w-6xl flex-col sm:min-h-[calc(100vh-2.5rem)]">
        <header className="flex items-center justify-between py-2 sm:py-3">
          <div className="flex items-center gap-3">
            <div className="flex size-9 items-center justify-center rounded-lg bg-foreground text-xs font-semibold text-white shadow-[0_8px_20px_rgba(15,23,42,0.16)] sm:size-10 sm:text-sm">
              OR
            </div>
            <div>
              <p className="text-sm font-semibold text-foreground">OpsRunner</p>
        ...
        <section className="grid flex-1 items-start gap-7 py-6 sm:gap-9 sm:py-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:gap-12 lg:py-10">
